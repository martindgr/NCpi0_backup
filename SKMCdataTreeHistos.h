...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   void     LoopSelection(std::string horn_current, std::string osc_sample);
   void		LoopHistograms(std::string horn_current, std::string osc_sample);
...
*/	
	double fhcfileWeights[6] = {1396.245 / 634881., 50.964 / 634600., 26.663 / 126899., 2.884 / 126728.,1483.994 / 126916., 52.939 / 126984.};
	double rhcfileWeights[6] = {208.369 / 634659., 353.789 / 633988., 8.941 / 127262., 6.811 / 127013., 215.099 / 127278., 376.420 / 126812.};
	...
	void FormatHist2D(TH2D* h);
	void AddEventToHisto(int cutID);
	bool CanReco();
	bool IsfQPi0();
	...
	void DrawHist2D(TH2D* histo, std::string mode, std::string x_param,  std::string y_param, std::string horn_current, std::string osc_sample, std::string figs_subdir);
	float rc_par();
...
private:
   ...
   // TH1D* NC0ther_nhitac_histo = new TH1D ("nhitac_bg", "",100, 0, 100);
		
//    TH1D* dwall_sig = new TH1D ("dwall_sig", "",100, 0, 1600);
//    TH1D* dwall_bg = new TH1D ("dwall_bg", "",100, 0, 1600);

  //  TH1D* towall_sig = new TH1D ("towall_sig", "",100, 0, 3500 );
  //  TH1D* towall_bg = new TH1D ("towall_bg", "",100, 0, 3500);
	


	TH1D* CC0pi_pi0_e_PID_histo = new TH1D ("CC0pi_pi0_e_PID_histo", "",40, -100, 100);
	TH1D* CC1pipm_pi0_e_PID_histo = new TH1D ("CC1pipm_pi0_e_PID_histo", "",40, -100, 100);
    TH1D* CC1pi0_pi0_e_PID_histo = new TH1D ("CC1pi0_pi0_e_PID_histo", "",40, -100, 100);
    TH1D* CC0ther_pi0_e_PID_histo = new TH1D ("CCOther_pi0_e_PID_histo", "",40, -100, 100);
    TH1D* NC1pi0_pi0_e_PID_histo = new TH1D ("NC1pi0_pi0_e_PID_histo", "",40, -100, 100);
    TH1D* NC1pipm_pi0_e_PID_histo = new TH1D ("NC1pipm_pi0_e_PID_histo", "",40, -100, 100);
    TH1D* NC0ther_pi0_e_PID_histo = new TH1D ("NCOther_pi0_e_PID_histo", "",40, -100, 100);
	
	TH1D* CC0pi_piplus_mu_PID_histo = new TH1D ("CC0pi_piplus_mu_PID_histo", "",40, -100, 100);
	TH1D* CC1pipm_piplus_mu_PID_histo = new TH1D ("CC1pipm_piplus_mu_PID_histo", "",40, -100, 100);
    TH1D* CC1pi0_piplus_mu_PID_histo = new TH1D ("CC1pi0_piplus_mu_PID_histo", "",40, -100, 100);
    TH1D* CC0ther_piplus_mu_PID_histo = new TH1D ("CCOther_piplus_mu_PID_histo", "",40, -100, 100);
    TH1D* NC1pi0_piplus_mu_PID_histo = new TH1D ("NC1pi0_piplus_mu_PID_histo", "",40, -100, 100);
    TH1D* NC1pipm_piplus_mu_PID_histo = new TH1D ("NC1pipm_piplus_mu_PID_histo", "",40, -100, 100);
    TH1D* NC0ther_piplus_mu_PID_histo = new TH1D ("NCOther_piplus_mu_PID_histo", "",40, -100, 100);
    
	TH1D* CC0pi_e_mu_PID_histo = new TH1D ("CC0pi_e_mu_PID_histo", "",40, -100, 100);
	TH1D* CC1pipm_e_mu_PID_histo = new TH1D ("CC1pipm_e_mu_PID_histo", "",40, -100, 100);
    TH1D* CC1pi0_e_mu_PID_histo = new TH1D ("CC1pi0_e_mu_PID_histo", "",40, -100, 100);
    TH1D* CC0ther_e_mu_PID_histo = new TH1D ("CCOther_e_mu_PID_histo", "",40, -100, 100);
    TH1D* NC1pi0_e_mu_PID_histo = new TH1D ("NC1pi0_e_mu_PID_histo", "",40, -100, 100);
    TH1D* NC1pipm_e_mu_PID_histo = new TH1D ("NC1pipm_e_mu_PID_histo", "",40, -100, 100);
    TH1D* NC0ther_e_mu_PID_histo = new TH1D ("NCOther_e_mu_PID_histo", "",40, -100, 100);
    
	TH1D* CC0pi_rc_param_histo = new TH1D ("CC0pi_rc_param_histo", "",40, 0, 300);
	TH1D* CC1pipm_rc_param_histo = new TH1D ("CC1pipm_rc_param_histo", "",40, 0, 300);
    TH1D* CC1pi0_rc_param_histo = new TH1D ("CC1pi0_rc_param_histo", "",40, 0, 300);
    TH1D* CC0ther_rc_param_histo = new TH1D ("CCOther_rc_param_histo", "",40, 0, 300);
    TH1D* NC1pi0_rc_param_histo = new TH1D ("NC1pi0_rc_param_histo", "",40, 0, 300);
    TH1D* NC1pipm_rc_param_histo = new TH1D ("NC1pipm_rc_param_histo", "",40, 0, 300);
    TH1D* NC0ther_rc_param_histo = new TH1D ("NCOther_rc_param_histo", "",40, 0, 300);
    
	TH2D* CC0pi_nllr_2Rother_pipi_histo = new TH2D ("CC0pi_nllr_2Rother_pipi_histo", "",40, 0, 300, 40, -50, 500);
	TH2D* CC1pipm_nllr_2Rother_pipi_histo = new TH2D ("CC1pipm_nllr_2Rother_pipi_histo", "",40, 0, 300, 40, -50, 500);
    TH2D* CC1pi0_nllr_2Rother_pipi_histo = new TH2D ("CC1pi0_nllr_2Rother_pipi_histo", "",40, 0, 300, 40, -50, 500);
    TH2D* CC0ther_nllr_2Rother_pipi_histo = new TH2D ("CCOther_nllr_2Rother_pipi_histo", "",40, 0, 300, 40, -50, 500);
    TH2D* NC1pi0_nllr_2Rother_pipi_histo = new TH2D ("NC1pi0_nllr_2Rother_pipi_histo", "",40, 0, 300, 40, -50, 500);
    TH2D* NC1pipm_nllr_2Rother_pipi_histo = new TH2D ("NC1pipm_nllr_2Rother_pipi_histo", "",40, 0, 300, 40, -50, 500);
    TH2D* NC0ther_nllr_2Rother_pipi_histo = new TH2D ("NCOther_nllr_2Rother_pipi_histo", "",40, 0, 300, 40, -50, 500);


	TH1D* CC0pi_nllr_pipi_e_histo = new TH1D ("CC0pi_nllr_pipi_e_histo", "",  40, -50, 500);
	TH1D* CC1pipm_nllr_pipi_e_histo = new TH1D ("CC1pipm_nllr_pipi_e_histo", "",  40, -50, 500);
    TH1D* CC1pi0_nllr_pipi_e_histo = new TH1D ("CC1pi0_nllr_pipi_e_histo", "",  40, -50, 500);
    TH1D* CC0ther_nllr_pipi_e_histo = new TH1D ("CCOther_nllr_pipi_e_histo", "",  40, -50, 500);
    TH1D* NC1pi0_nllr_pipi_e_histo = new TH1D ("NC1pi0_nllr_pipi_e_histo", "",  40, -50, 500);
    TH1D* NC1pipm_nllr_pipi_e_histo = new TH1D ("NC1pipm_nllr_pipi_e_histo", "",  40, -50, 500);
    TH1D* NC0ther_nllr_pipi_e_histo = new TH1D ("NCOther_nllr_pipi_e_histo", "",  40, -50, 500);


	TH1D* CC0pi_sum_eloss_pipi_histo = new TH1D ("CC0pi_sum_eloss_pipi_histo", "",40, 0, 300);
	TH1D* CC1pipm_sum_eloss_pipi_histo = new TH1D ("CC1pipm_sum_eloss_pipi_histo", "",40, 0, 300);
    TH1D* CC1pi0_sum_eloss_pipi_histo = new TH1D ("CC1pi0_sum_eloss_pipi_histo", "",40, 0, 300);
    TH1D* CC0ther_sum_eloss_pipi_histo = new TH1D ("CCOther_sum_eloss_pipi_histo", "",40, 0, 300);
    TH1D* NC1pi0_sum_eloss_pipi_histo = new TH1D ("NC1pi0_sum_eloss_pipi_histo", "",40, 0, 300);
    TH1D* NC1pipm_sum_eloss_pipi_histo = new TH1D ("NC1pipm_sum_eloss_pipi_histo", "",40, 0, 300);
    TH1D* NC0ther_sum_eloss_pipi_histo = new TH1D ("NCOther_sum_eloss_pipi_histo", "",40, 0, 300);

	TH1D* CC0pi_ndcy_histo = new TH1D ("CC0pi_ndcy_histo", "",40, 0, 10);
	TH1D* CC1pipm_ndcy_histo = new TH1D ("CC1pipm_ndcy_histo", "",40, 0, 10);
    TH1D* CC1pi0_ndcy_histo = new TH1D ("CC1pi0_ndcy_histo", "",40, 0, 10);
    TH1D* CC0ther_ndcy_histo = new TH1D ("CCOther_ndcy_histo", "",40, 0, 10);
    TH1D* NC1pi0_ndcy_histo = new TH1D ("NC1pi0_ndcy_histo", "",40, 0, 10);
    TH1D* NC1pipm_ndcy_histo = new TH1D ("NC1pipm_ndcy_histo", "",40, 0, 10);
    TH1D* NC0ther_ndcy_histo = new TH1D ("NCOther_ndcy_histo", "",40, 0, 10);

	TH1D* CC0pi_towall_histo = new TH1D ("CC0pi_towall_histo", "",40, 0, 300);
	TH1D* CC1pipm_towall_histo = new TH1D ("CC1pipm_towall_histo", "",40, 0, 300);
    TH1D* CC1pi0_towall_histo = new TH1D ("CC1pi0_towall_histo", "",40, 0, 300);
    TH1D* CC0ther_towall_histo = new TH1D ("CCOther_towall_histo", "",40, 0, 300);
    TH1D* NC1pi0_towall_histo = new TH1D ("NC1pi0_towall_histo", "",40, 0, 300);
    TH1D* NC1pipm_towall_histo = new TH1D ("NC1pipm_towall_histo", "",40, 0, 300);
    TH1D* NC0ther_towall_histo = new TH1D ("NCOther_towall_histo", "",40, 0, 300);

	TH1D* CC0pi_dwall_histo = new TH1D ("CC0pi_dwall_histo", "",40, 0, 300);
	TH1D* CC1pipm_dwall_histo = new TH1D ("CC1pipm_dwall_histo", "",40, 0, 300);
    TH1D* CC1pi0_dwall_histo = new TH1D ("CC1pi0_dwall_histo", "",40, 0, 300);
    TH1D* CC0ther_dwall_histo = new TH1D ("CCOther_dwall_histo", "",40, 0, 300);
    TH1D* NC1pi0_dwall_histo = new TH1D ("NC1pi0_dwall_histo", "",40, 0, 300);
    TH1D* NC1pipm_dwall_histo = new TH1D ("NC1pipm_dwall_histo", "",40, 0, 300);
    TH1D* NC0ther_dwall_histo = new TH1D ("NCOther_dwall_histo", "",40, 0, 300);

	TH2D* CC0pi_fQpi0nll_histo = new TH2D ("CC0pi_fQpi0nll_histo", "",40, 0, 300, 40, -50, 500);
	TH2D* CC1pipm_fQpi0nll_histo = new TH2D ("CC1pipm_fQpi0nll_histo", "",40, 0, 300, 40, -50, 500);
    TH2D* CC1pi0_fQpi0nll_histo = new TH2D ("CC1pi0_fQpi0nll_histo", "",40, 0, 300, 40, -50, 500);
    TH2D* CC0ther_fQpi0nll_histo = new TH2D ("CCOther_fQpi0nll_histo", "",40, 0, 300, 40, -50, 500);
    TH2D* NC1pi0_fQpi0nll_histo = new TH2D ("NC1pi0_fQpi0nll_histo", "",40, 0, 300, 40, -50, 500);
    TH2D* NC1pipm_fQpi0nll_histo = new TH2D ("NC1pipm_fQpi0nll_histo", "",40, 0, 300, 40, -50, 500);
    TH2D* NC0ther_fQpi0nll_histo = new TH2D ("NCOther_fQpi0nll_histo", "",40, 0, 300, 40, -50, 500);
	
    TH1D* CC0pi_evis_histo = new TH1D ("CC0pi_evis_histo", "",100, 0, 500);
	TH1D* CC1pipm_evis_histo = new TH1D ("CC1pipm_evis_histo", "",100, 0, 500);
    TH1D* CC1pi0_evis_histo = new TH1D ("NC0ther_evis_histo", "",100, 0, 500);
    TH1D* CC0ther_evis_histo = new TH1D ("CC0ther_evis_histo", "",100, 0, 500);
    TH1D* NC1pi0_evis_histo = new TH1D ("NC1pm_evis_histo", "",100, 0, 500);
    TH1D* NC1pipm_evis_histo = new TH1D ("NC1pipm_evis_histo", "",100, 0, 500);
    TH1D* NC0ther_evis_histo = new TH1D ("NC0ther_evis_histo", "",100, 0, 500);
    
//	TH1D* nring_sig = new TH1D ("nring_sig", "",5, 0, 5);
 //   TH1D* nring_bg = new TH1D ("nring_bg", "",5, 0, 5);
    
//	TH1D* ndcy_sig = new TH1D ("ndcy_sig", "",10, 0, 10);
 //   TH1D* ndcy_bg = new TH1D ("ndcy_bg", "",10, 0, 10);
	

    TH1D* CC0pi_pi0mass_histo = new TH1D ("NC0ther_pi0mass_histo", "",100, 0, 300);
	TH1D* CC1pipm_pi0mass_histo = new TH1D ("NC0ther_pi0mass_histo", "",100, 0, 300);
    TH1D* CC1pi0_pi0mass_histo = new TH1D ("NC0ther_pi0mass_histo", "",100, 0, 300);
    TH1D* CC0ther_pi0mass_histo = new TH1D ("NC0ther_pi0mass_histo", "",100, 0, 300);
    TH1D* NC1pi0_pi0mass_histo = new TH1D ("NC0ther_pi0mass_histo", "",100, 0, 300);
    TH1D* NC1pipm_pi0mass_histo = new TH1D ("NC0ther_pi0mass_histo", "",100, 0, 300);
    TH1D* NC0ther_pi0mass_histo = new TH1D ("NC0ther_pi0mass_histo", "",100, 0, 300);
	
//	TH2D* fq_e_mu_sig = new TH2D ("fq_e_mu_sig", "", 20, 0, 1000, 20, -200, 700);
//	TH2D* fq_e_mu_bg = new TH2D ("fq_e_mu_bg", "", 20, 0, 1000, 20, -200, 700);


//	TH2D* fq_e_pi0_sig = new TH2D ("fq_e_pi0_sig", "", 20, 0, 300, 20, -50, 500);
//	TH2D* fq_e_pi0_bg = new TH2D ("fq_e_pi0_bg", "", 20, 0, 300, 20, -50, 500);
